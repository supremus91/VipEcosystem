...
Public Class Special_Settings
    ...
    Private Sub Special_Settings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If cable_ACT = 1 Then
            OpenChildForm(New CableMenu(), sender)
            lblTitle.Text = "Cable connections"

            btnCable.Visible = True
            btnCert.Visible = False
            btnAcc.Visible = False

            Me.Size = New System.Drawing.Size(460, 250)
        ElseIf cert_ACT = 1 Then
            OpenChildForm(New CertificateMenu(), sender)
            lblTitle.Text = "Certificates"

            btnCert.Visible = True
            btnAcc.Visible = False
            btnCable.Visible = False

            Me.Size = New System.Drawing.Size(1240, 530)
        ElseIf acc_ACT = 1 Then
            OpenChildForm(New AccessoriesMenu(), sender)
            lblTitle.Text = "Accessories"

            btnAcc.Visible = True
            btnCert.Visible = False
            btnCable.Visible = False

            Me.Size = New System.Drawing.Size(1400, 630)
        End If
