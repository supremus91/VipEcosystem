...
Public Class PrezzoMenu
    ...
    Private Sub Special_Settings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        OpenChildForm(New Prezzo(), sender)

        lblTitle.Text = PJ_ref_star
        Me.Size = New System.Drawing.Size(1115, 530)
    ...
    Private Sub btnArchivio_Click(sender As Object, e As EventArgs) Handles btnPrezzo.Click

        OpenChildForm(New Prezzo(), sender)

        lblTitle.Text = PJ_ref_star
        Me.Size = New System.Drawing.Size(1115, 415)
