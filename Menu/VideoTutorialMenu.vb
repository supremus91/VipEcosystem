...
Public Class VideoTutorialMenu
    ...
    Private Sub Special_Settings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Size = New System.Drawing.Size(1530, 830)



        'AxVLCPlugin21.playlist.add(Video_Name)
        ...
        AxWindowsMediaPlayer1.URL = Video_Name
    ...
    Private Sub btnArchivio_Click(sender As Object, e As EventArgs) Handles btnTutorial.Click
